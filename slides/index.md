...
```ts
// AttributionViewModel in 4.8 Release
...
- [Demo Steps](https://github.com/jcfranco/uc-2018-customizing-widgets/tree/master/demos/custom-attribution-start/steps/STEPS.md)
